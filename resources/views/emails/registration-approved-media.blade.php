...
@section('title', 'Media Approval - Choose Your Info Session')
@section('headerTitle', "🎉 You're Approved for Media!")
@section('headerSubtitle', 'Welcome to the LionsGeek Media Program')
