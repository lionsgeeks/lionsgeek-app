...
<body>
    ...
    <div class="content">
        ...
        <p>This is a friendly reminder that you’re registered for an upcoming info session of the LionsGeek Coding
        ...
        <div class="rtl">
            ...
            <p>هذه تذكرة ودية بأنك مسجل لحضور جلسة تعريفية قادمة لبرنامج LionsGeek للبرمجة. يرجى مراجعة تفاصيل الجلسة
