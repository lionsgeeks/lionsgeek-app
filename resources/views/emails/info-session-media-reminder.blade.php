...
<head>
    <meta charset="utf-8">
    <title>تذكير - الإعلام</title>
</head>
<body style="font-family: Arial; direction: rtl; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto;">
        
        <h1 style="color: #6f42c1; text-align: center;">
            🎬 Lions Geek - تخصص الإعلام
        </h1>
        
        <h2>مرحباً {{ $participant->full_name }}</h2>
        
        <p>نذكرك بأنه لم تقم بعد باختيار جلسة المعلومات لتخصص الإعلام.</p>
        
        <div style="background: #f8f9fa; padding: 15px; border-radius: 5px; margin: 20px 0;">
            <h3>🎨 ماذا ستتعلم؟</h3>
            <ul>
                <li>تحرير الفيديو والصوت</li>
                <li>التصميم الجرافيكي</li>
                <li>إدارة وسائل التواصل</li>
                <li>التصوير الإبداعي</li>
            </ul>
        </div>
        ...
        @forelse($availableSessions as $session)
            <div style="border: 1px solid #ddd; padding: 15px; margin: 10px 0; border-radius: 5px;">
                ...
                <a href="{{ $selectionUrl }}?session={{ $session->id }}" 
                   style="background: #6f42c1; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
                    اختر هذه الجلسة
                </a>
            </div>
        @empty
