              ...
              <tr>
                <td class="sm-p-6" style="border-radius: 8px; background-color: #fffffe; padding: 24px 36px; border: 1px solid #e2e8f0">
                  ...
                  <p style="font-size: 16px; line-height: 24px; color: #475569">
                    We are excited to invite you to join the {{ $school }} School at LionsGeek! Your passion and potential have
                  ...
                  <p style="font-size: 16px; line-height: 24px; color: #475569">
                    ...
                    the art of coding to creating impactful projects, your journey begins here.
                  </p>
                  <div role="separator" style="line-height: 4px">&zwj;</div>
                  <p style="font-size: 16px; line-height: 24px; color: #475569">
                    ...
                    <tr>
                      <td class="sm-p-6" href="https://lionsgeek.ma" style="padding-left: 36px; padding-right: 36px; padding-bottom: 32px">
                        <div style="font-weight: 600">
                          ...
                          <a href="https://x.com/LionsGeek?t=oZV_osSHbR3MV7uSV3AIIA&s=09" style="padding: 4px; color: #1DA1F2">X (Twitter)</a>
                        </div>
                      </td>
                    </tr>
                  </table>
