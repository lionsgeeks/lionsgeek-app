                    ...
                    >
                        ...
                        >
                            <a
                                ...
                                className={` px-2 py-2 text-sm relative lg:after:absolute after:border-b-[2px]  after:bottom-[-13px] after:left-0 after:w-0 hover:after:w-[100%] after:transition-all after:duration-[0.35s]  ${location.pathname == "/"
                            ...
                            <div
                                ref={formationRef}
                                className={`relative lg:after:absolute after:border-b-[2px]  after:bottom-[-13px] after:left-0 after:w-0 hover:after:w-[100%] after:transition-all after:duration-[0.35s] ${location.pathname == "/coding" ||
                            ...
                            >
                                ...
                                >
                                    <span className={`  ${darkMode ? "text-white" : "#0f0f0f"}`}>
                                        <TransText en="Training" fr="Formation" ar="التكوين" />
                                    </span>
                                    <svg
                                ...
                                {formationMenu && (
                                    ...
                                    >
                                        <div
                                            className={`py-2  rounded-md lg:min-w-[15vw] min-w-[40vw] shadow-lg dark-mode:bg-gray-700 flex flex-col gap-2 ${darkMode ? "bg-[#0f0f0f] " : "bg-white"
                                                }`}
                                        >
                                            <a
                                                id="codingLink"
                                            ...
                                            >
                                                ...
                                                <CodeXml size={18} color={darkMode ? "#fff" : "#0f0f0f"} />
                                                <p
                                                    className={`text-[0.9rem] ${darkMode && "text-white"
                                                        } `}
                                                >
                                                    <TransText en="Learn to code" fr="Apprenez à coder" ar="تعلم البرمجة" />
                                                </p>
                                            </a>
                                            <a
                                                id="mediaLink"
                                            ...
                                            >
                                                <Camera size={18} color={darkMode ? "#fff" : "#0f0f0f"} />
                                                <p
                                                    className={`text-[0.9rem]  ${darkMode && "text-white"
                                                        }`}
                                                >
                                                    <TransText en="Master media arts" fr="Maîtriser les arts médiatiques" ar="إتقان فنون الإعلام" />
                                                </p>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <a
                                ...
                                // className={`${darkMode ? "text-white" : "text-[#0f0f0f]"} px-2 py-2 text-sm relative
                                //   `}
                                className={`${darkMode ? "text-white" : "#0f0f0f"} px-2 py-2 text-sm relative  lg:after:absolute after:border-b-[2px]  after:bottom-[-13px] after:left-0 after:w-0 hover:after:w-[100%] after:transition-all after:duration-[0.35s]  ${location.pathname == "/coworking"
                                    ? "font-medium  after:border-alpha after:w-[100%]"
                                    : "after:border-gray-300"
                                    }`}
                            ...
                            >
                                <TransText en="Events" fr="Événements" ar="الفعاليات" />
                            </a>
                            <a
                                href={"/pro"}
                                onClick={() => setIsOpen(false)}
                                className={`${darkMode ? "text-white" : "#0f0f0f"
                                    }  px-2 py-2 text-sm relative lg:after:absolute after:border-b-[2px]  after:bottom-[-13px] after:left-0 after:w-0 hover:after:w-[100%] after:transition-all after:duration-[0.35s]  ${location.pathname == "/pro"
                                        ? "font-medium  after:border-alpha after:w-[100%]"
                                        : "after:border-gray-300"
                                    }`}
                            >
                                <TransText en="LionsGeek Pro" fr="LionsGeek Pro" ar="ليونزجيك برو " />
                            </a>
                            ...
                            <div
                                ref={aboutRef}
                                className={`relative  lg:after:absolute after:border-b-[2px]  after:bottom-[-13px] after:left-0 after:w-0 hover:after:w-[100%] after:transition-all after:duration-[0.35s] ${location.pathname == "/blog" ||
                            ...
                            >
                                ...
                                {aboutMenu && (
                                    ...
                                    >
                                        <div
                                            className={`py-2  ${darkMode ? "bg-[#0f0f0f]" : "bg-white"
                                                } rounded-md lg:min-w-[15vw] min-w-[40vw] shadow-lg dark-mode:bg-gray-700 flex flex-col gap-2`}
                                        >
                                            <a
                                                id="codingLink"
                                                href={"/about"}
                                            ...
                                            >
                                                ...
                                                <MessageCircleQuestion size={18} color={darkMode ? "#fff" : "#0f0f0f"} />
                                                <p
                                                    className={`text-[0.9rem] ${darkMode && "text-white"
                                                        }`}
                                                >
                                                    <TransText en="Who We Are" fr="Qui sommes-nous" ar="من نحن" />
                                                </p>
                                            </a>
                                            <a
                                                id="mediaLink"
                                            ...
                                            >
                                                <BookOpen size={18} color={darkMode ? "#fff" : "#0f0f0f"} />

                                                <p
                                                    className={`text-[0.9rem] ${darkMode && "text-white"
                                                        }`}
                                                >
                                                    <TransText en="Blog" fr="Blog" ar="مدونة" />
                                                </p>
                                            </a>
                                            <a
                                                id="mediaLink"
                                            ...
                                            >
                                                ...
                                                <GalleryHorizontalEnd size={18} color={darkMode ? "#fff" : "#0f0f0f"} />
                                                <p
                                                    className={`text-[0.9rem] ${darkMode && "text-white"
                                                        }`}
                                                >
                            ...
                            >
                                ...
                                {languageIsOpen && (
                                    <div className={`absolute top-10 ${selectedLanguage === "ar" ? "right-0" : ""}  z-30 mt-2`}>
                                        <div
                                            className={`rounded-md  flex flex-col items-start gap-2 shadow-lg   py-2 ${darkMode ? "bg-[#0f0f0f]" : "bg-white "
                                                }`}
                                        >
