...
const Coworking = () => {
    ...
    const services = [
        {
            icon: <Wifi size={60} color="yellow" />,
        ...
        {
            icon: <Camera size={60} color="yellow" />,
        ...
        {
            icon: <Podcast size={60} color="yellow" />,
        ...
        {
            icon: <Gamepad size={60} color="yellow" />,
        ...
        {
            icon: <Users size={60} color="yellow" />,
            title: "Réseautage",
        ...
        {
            icon: <Shield size={60} color="yellow" />,
