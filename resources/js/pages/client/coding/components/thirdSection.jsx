...
export const ThirdSection = () => {
    ...
    return (
        ...
        >
            ...
            <div
                className={`flex lg:flex-row lg:flex-wrap z-20 flex-col items-center gap-10 justify-center ${selectedLanguage === "ar" ? "lg:flex-row-reverse text-right" : ""
                    } `}
            >
                {road.map(({ description, title, Icon }, index) => (
                    ...
                    >
                        ...
                        <Icon
                            size={50}
                            className={` absolute -top-6 ${title.en === "Coding School" ? "stroke-alpha" : "fill-alpha"
                                } `}
                        />
                        <h1
