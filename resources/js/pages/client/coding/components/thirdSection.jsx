...
export const ThirdSection = () => {
    ...
    return (
        <div className="flex flex-col gap-8 overflow-hidden px-5 py-16 lg:px-16" style={{ backgroundColor: darkMode ? '#0f0f0f' : undefined }}>
            ...
            >
                {road.map(({ description, title, Icon }, index) => (
                    ...
                    >
                        ...
                        <Icon size={50} className={`absolute -top-6 ${title.en === 'Coding School' ? 'stroke-alpha' : 'fill-alpha'} `} />
                        <h1
