    ...
    let cards = [
        {
            ...
            description: {
                ...
                ar: "(UI/UX Design) انضم إلى الدورات المتقدمة لدينا في تصميم واجهة المستخدم / تجربة المستخدم ، وتعلم مهارات العلامة التجارية الشخصية، واحصل على مساعدة في إنشاء السيرة الذاتية ورسائل الغلاف.",
        ...
        >
            ...
            <div className="flex lg:flex-row flex-col gap-8 justify-center">
                {cards.map((element, index) => (
                    <div
                        key={index}
                        className={`lg:w-[25%] bg-beta p-8 flex flex-col justify-between gap-4 rounded-lg hover:scale-105 duration-300 ${selectedLanguage === "ar" ? "text-right items-end" : ""
                            }`}
