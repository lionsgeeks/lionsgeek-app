            ...
            <div className="space-y-6">
                ...
                <div>
                    <label className={`block text-sm font-medium mb-2 ${darkMode ? 'text-white' : 'text-gray-700'}`}>
                        <TransText en="How did you hear about this training?" fr="Comment avez-vous entendu parler de cette formation ?" ar="كيف سمعت عن هذا التدريب؟" />
                        <Required />
                    </label>
                    <select
                    ...
                    >
                        <option value="" disabled className={darkMode ? 'bg-gray-700' : 'bg-white'}>
                            <TransText en="Select how you heard about us" fr="Sélectionnez comment vous avez entendu parler de nous" ar="اختر كيف سمعت عنا" />
                        </option>
                    ...
                    {errors.how_heard_about_formation && <span className="text-sm text-red-500 mt-1">{errors.how_heard_about_formation}</span>}
                </div>
                ...
                <div>
                    ...
                    {errors.current_commitments && <span className="text-sm text-red-500 mt-1">{errors.current_commitments}</span>}
                </div>
            </div>
        </div>
    );
