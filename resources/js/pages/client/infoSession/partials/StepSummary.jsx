...
export default function StepSummary({ data, errors, setCurrentStep }) {
    ...
    const goToField = (fieldKey) => {
        ...
        const map = {
            full_name: 1, email: 1, phone: 1, birthday: 1, city: 1, region: 1,
            education_level: 2, current_situation: 2,
            has_training: 3, previous_training_details: 3, why_join_formation: 3,
            objectives_after_formation: 4, priority_learning_topics: 4, arabic_level: 4, french_level: 4, english_level: 4,
            how_heard_about_formation: 5, current_commitments: 5,
        };
