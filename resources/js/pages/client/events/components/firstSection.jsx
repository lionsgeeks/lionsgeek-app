...
export default function FirstSectionEvent() {
    ...
    return (
        <div
            className="flex lg:flex-row flex-col-reverse overflow-x-hidden justify-between w-full lg:px-5 lg:pt-[3.5em] pt-[3rem] pb-[5em]"
            style={backgroundStyle}
        >
            <div ref={leftside} className="flex justify-center items-center lg:w-[50%] w-full">
                <div className="lg:px-16 px-3 flex flex-col gap-6 w-full" style={textStyle}>
                    <h1 className="font-bold lg:text-[60px] text-[45px] text-start">
                        <TransText
                            fr="Innovation & Inspiration"
                            ar="الابتكار والإلهام"
                            en="Innovation & Inspiration"
                        />
                    </h1>
                    ...
                    <p className="font-light flex gap-2 text-lgs items-center">
                        <svg
                        ...
                        <TransText
                            fr="Casablanca, Ain Sebaa"
                            ar="الدار البيضاء، عين السبع"
                            en="Casablanca, Ain Sbaa"
                        />
                    </p>
                    <button
                        onClick={() =>
