...
const Policy = () => {
    ...
    return (
        <AppLayout>
            <Head title="policy" />
            <div>
                <div className={`overflow-hidden px-4 pt-24 lg:px-16 lg:pt-28 ${darkMode ? 'bg-[#0f0f0f]' : ''} `}>
                    <div
                        className={`flex w-full flex-col-reverse items-center gap-2 md:flex-row lg:flex-row ${
                            selectedLanguage == 'ar' ? 'lg:flex-row-reverse' : ''
                        }`}
                    >
                        <div ref={leftside} className="flex w-full flex-col gap-5 px-7 md:w-1/2 md:gap-2 lg:w-1/2">
                        ...
                        <div ref={rightside} className="flex w-full justify-center md:w-1/2 md:items-center lg:w-1/2">
                            <img loading="lazy" className="w-[80%]" src={herocowork} alt="img" />
                        </div>
                    </div>
                    {/* Content Section */}
                    <div className="container mx-auto px-4 py-8">
                        <div className="mx-auto mb-8 max-w-4xl rounded-lg p-8">
                                ...
                                <section>
                                    <h2 className="mb-4 text-2xl font-bold text-yellow-400">
                                        <TransText
                                            ...
                                            fr="1. Collecte des données personnelles"
                                        />
                                    </h2>
